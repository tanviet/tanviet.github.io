...
/**
 * Helper function to show a feed
 */
...
exports.update = function(req, res) {
    ...
    // We call Lodash's extend method in order to modify the feed's properties with the ones that came from the user. 
